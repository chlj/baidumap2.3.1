 ...
 *
 */
public class baidu_customRouteOverlayDemo extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.baidumap_activity_customroute);
		...
		RouteOverlay routeOverlay = new RouteOverlay(baidu_customRouteOverlayDemo.this, mMapView);		
