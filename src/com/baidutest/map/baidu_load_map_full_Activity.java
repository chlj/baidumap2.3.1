 ...
 *
 */
public class baidu_load_map_full_Activity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.baidumap_activity_load_map_full);
		...
		mMapListener = new MKMapViewListener() {
			...
			public void onClickMapPoi(MapPoi mapPoiInfo) {
				...
				if (mapPoiInfo != null) {
					...
					Toast.makeText(baidu_load_map_full_Activity.this, title,
			...
			public void onMapLoadFinish() {
				Toast.makeText(baidu_load_map_full_Activity.this, "地图加载完成",
						Toast.LENGTH_SHORT).show();
