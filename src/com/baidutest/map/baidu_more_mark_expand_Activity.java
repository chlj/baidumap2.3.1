...
public class baidu_more_mark_expand_Activity extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.baidumap_activity_more_expand_mark);
	...
	public void initOverlay() {
		...
		// -------------------------
		mPopView = getLayoutInflater().inflate(R.layout.act_paopao2, null); // 动态加载弹出层
		popupText = (TextView) mPopView.findViewById(R.id.textcache);
		popupText.setText("监利县人民医院");
		pop.showPopup(mPopView, p1, 5);

		
		View mPopViews = getLayoutInflater()
				.inflate(R.layout.act_paopao2, null); // 动态加载弹出层
		TextView popupText2 = (TextView) mPopViews.findViewById(R.id.textcache);
		popupText2.setText("监利县实验小学");
		pop.showPopup(mPopViews, p2, 5);
		// --------------------------------
	...
	public class MyOverlay extends ItemizedOverlay {
		...
		public boolean onTap(final int index) {
			...
			mCurItem = item;
			Toast.makeText(
					baidu_more_mark_expand_Activity.this,
			...
			popupText.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (index == 0) {
						Toast.makeText(baidu_more_mark_expand_Activity.this,
